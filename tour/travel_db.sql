...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=235774720ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tms&table=tblusers">`tms`.`tblusers`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tms&table=admin">`tms`.`admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tms&table=tbltourpackages">`tms`.`tbltourpackages`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tms&table=tblpages">`tms`.`tblpages`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tms&table=tblissues">`tms`.`tblissues`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tms&table=tblenquiry">`tms`.`tblenquiry`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tms&table=tblbooking">`tms`.`tblbooking`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=travel_db&table=user_contact">`travel_db`.`user_contact`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=travel_db&table=signup">`travel_db`.`signup`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=travel_db&table=booked_pac_info">`travel_db`.`booked_pac_info`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="446e2a41447045747c2a353976655539">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="travel_db" targettable="signup">
            ...
            Queried time
                            ...
                            targetdb="travel_db" targettable="booked_pac_info">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `travel_db`.`booked_pac_info` ( `id` INT NOT NULL AUTO_INCREMENT ,  `fullname` VARCHAR(100) NULL ,  `address` VARCHAR(100) NULL ,  `mobilenumber` VARCHAR(100) NULL ,  `emailaddress` VARCHAR(100) NULL ,  `totalpeople` VARCHAR(100) NULL ,  `bookingid` VARCHAR(100) NULL ,  `startingdate` VARCHAR(100) NULL ,  `comment` VARCHAR(1000) NULL ,  `userid` VARCHAR(100) NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="travel_db" targettable="user_contact">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `travel_db`.`user_contact` ( `id` INT NOT NULL AUTO_INCREMENT ,  `fname` VARCHAR(100) NULL ,  `lname` VARCHAR(100) NULL ,  `country` VARCHAR(100) NULL ,  `subject` VARCHAR(1000) NULL ,  `userid` VARCHAR(100) NULL ,  `useremail` VARCHAR(100) NULL ,  `mob_num` VARCHAR(100) NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="travel_db" targettable="signup">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `user_contact`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="travel_db" targettable="user_contact">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">/*!40101 SET COLLATION_CONNECTION=@OLD_COLLATION_CONNECTION */;</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="tms" targettable="tblbooking">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tblbooking`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="tms" targettable="tblenquiry">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tblenquiry`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="tms" targettable="tblissues">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tblissues`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="tms" targettable="tblpages">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tblpages`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="tms" targettable="tbltourpackages">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tbltourpackages`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="tms" targettable="tblusers">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tblusers`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="tms" targettable="admin">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `admin`(`id`, `UserName`, `Password`, `updationDate`) VALUES (&#039;2&#039;,&#039;admin&#039;,&#039;admin&#039;,&#039;[value-4]&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="tms" targettable="admin">
                            <div class="action_content">
