    ...
    <div class="header">
     ...
     <div class="menu">
        <ul class="menus">
            ...
            <li class="lista"><a href="privacypolicy.php">Privacy Policy</a></li>
