...
<body>
    <div class="header">
     ...
     <div class="menu">
        <ul class="menus">
            ...
            <li class="lista"><a href="contact.php">Contact Us</a></li>
        </ul>
    </div>
    ...
    <hr>
    <div class="address">
        <h4>Address: Kathmandu '10' balaju</h4>
        <h4>Near Bhatbhateni</h4>
        <h4>Mobile: 9800000000</h4>
    </div>
